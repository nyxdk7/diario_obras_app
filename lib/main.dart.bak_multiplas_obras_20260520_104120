...
class DiarioDetalhePage extends StatelessWidget {
  ...
  Future<void> aprovarDiario(BuildContext context) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Diário aprovado com sucesso.'),
        ),
      );
  ...
  Future<void> devolverDiario(BuildContext context) async {
          ...
          actions: [
            ...
            FilledButton.icon(
              onPressed: () {
                ...
                if (texto.isEmpty) {
                  Navigator.of(context).pop('Registro devolvido para correção.');
                  return;
                }
    ...
    try {
      await AuthService().devolverDiarioMobile(
        id,
        motivo: motivo,
      );
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Diário devolvido para correção.'),
        ),
      );
